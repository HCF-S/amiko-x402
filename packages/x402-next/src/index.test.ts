...
import { findMatchingRoute, findMatchingPaymentRequirements } from "@heyamiko/x402/shared";
import { getPaywallHtml } from "@heyamiko/x402/paywall";
import {
  FacilitatorConfig,
  Network,
...
import { useFacilitator } from "@heyamiko/x402/verify";
import { paymentMiddleware } from "./index";

// Mock dependencies
vi.mock("@heyamiko/x402/verify", () => ({
  useFacilitator: vi.fn(),
}));

vi.mock("@heyamiko/x402/paywall", () => ({
  getPaywallHtml: vi.fn(),
}));

vi.mock("@heyamiko/x402/shared", async importOriginal => {
